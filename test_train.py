...
if __name__ == '__main__':
    ...
    for file_index in range(len(img_files[0:5])):
        ...
        results = Image.fromarray((results * 127.5).astype(np.uint8))
        results.save('./train_image/test_{:02}_raw.png'.format(file_index+1))
        ...
        #plt.show()
        '''
        pic.save('./train_image/test_{:02}.png'.format(file_index+1))
